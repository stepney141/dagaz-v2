...
import { promotion } from "./international-checkers-dagaz-promotion.js";
import { maximal_capturing } from './maximal-captures-dagaz.js';
...
class InternationalCheckerClient {
  constructor () {
    this.client = new DagazClient({
      game: game_rules,
      extention: [ promotion, maximal_capturing ]
    });
...
export { InternationalCheckerClient };
